  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'grid min-w-[9.5rem] items-start gap-1.5 rounded-lg border border-border/80 bg-background/95 backdrop-blur-md px-3 py-2 text-xs shadow-xl transition-all duration-150',
          className
        )}
      >
        ...
        {payload.map((item: any) => {
          ...
          return (
            ...
            >
              ...
              <span className="font-medium text-foreground">{itemConfig?.label || item.value}</span>
            </div>
          )
        })}
      </div>
